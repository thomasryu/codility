...
function solution(A) {
  ...
  // We save the current lowest stock price and current profit
  // if the current profit is higher than previous max profit, we update max profit
  A.forEach((a) => {
    if (a < minStock) {
      minStock = a
    } else {
      const currentProfit = a - minStock
